...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        # coco unified segmentation lsj new baseline
            ...
            return build_detection_train_loader(cfg, mapper=mapper)
        # synthhomes sem seg
        elif cfg.INPUT.DATASET_MAPPER_NAME == "synthhomes_semantic" or cfg.INPUT.DATASET_MAPPER_NAME == "blfloors_semantic" or cfg.INPUT.DATASET_MAPPER_NAME == "bvhomes_semantic" or cfg.INPUT.DATASET_MAPPER_NAME == "bvrooms_semantic":
